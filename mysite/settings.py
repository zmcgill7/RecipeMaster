...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-gtya(76p!=3k2j_f3%b9j54f1mi4%$+$64%j%$q+w6y8gi4k-6')
...
USE_FIRESTORE_AUTH = os.environ.get('USE_FIRESTORE_AUTH', 'False') == 'True'

if USE_FIRESTORE_AUTH:
    AUTHENTICATION_BACKENDS = ['RecipeMaster.auth_backend.FirestoreAuthBackend']
...
MIDDLEWARE = [
    ...
    'RecipeMaster.auth_backend.FirestoreSessionCleanupMiddleware',
